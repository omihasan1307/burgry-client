    ...
    <div className="max-w-screen-xl mx-auto my-32 ">
      <div className=" grid lg:grid-cols-3 gap-10 lg:gap-0 place-items-center  justify-center">
        <Zoom triggerOnce={true}>
          <div className=" rounded flex items-center h-[150px] w-[33rem] lg:w-[23rem] bg-[#FFBA00] overflow-hidden">
        ...
        <Zoom triggerOnce={true}>
          <div className=" rounded flex items-center h-[150px] w-[33rem] lg:w-[23rem] bg-[#007936]  overflow-hidden ">
            <div className="relative w-[13.75rem] -mx-10 ">
              <img
        ...
        <Zoom triggerOnce={true}>
          <div className=" rounded flex items-center h-[150px] w-[33rem] lg:w-[23rem] bg-[#CC3433] overflow-hidden">
